...
public class CoursDAO extends DAO<Cours>{
	...
	//Recherche toute les cours en fonctions du moniteur.-------------------------------
		public ArrayList<Cours> findByMonitor(int id_moniteur){
			ArrayList<Cours> liste = new ArrayList<Cours>();
			
			try{
				ResultSet result = this.connect.createStatement(
						ResultSet.TYPE_FORWARD_ONLY,
						ResultSet.CONCUR_READ_ONLY).executeQuery("SELECT * FROM Cours WHERE id_moniteur = " + id_moniteur);
